...
if($_SESSION['admin_name']=='') {
	...
	include(PATH_TO_CLASS."class.database.php");
}

$cn = mysql_connect("localhost","root","") or die ("Database Connection Error.");
mysql_select_db("just4funcarnival",$cn);
?>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
	<tr>
		...
		<td width="55%">
			<textarea name="t1" rows="7" cols="70"><?php=stripslashes($_POST[t1])?></textarea>
		</td>
		<td width="32%">
				...
				<tr>
					<td align="center">
						<select name="table_name" onChange="show_table();">
							...
							?>
							<option value="<?php echo $rec_show_all[0]; ?>" <?php echo ($rec_show_all[0] == $_POST['table_name'])?'SELECTED':''; ?> > <?php echo $rec_show_all[0]; ?>
							</option>
							<?php } mysql_free_result($rs_show_all); ?>
						</select>
						<BR><br>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="1" align="left" height="50">
