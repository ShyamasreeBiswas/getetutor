  ...
  <tr>
    <td align="center">
		<table width="100%" align="center" cellpadding="5" cellspacing="2">
          ...
          <tr> 
          <td align="right" valign="top" class="tbllogin">Can Upload Files </td>
          <td align="center" valign="top" class="tbllogin">:</td>
          <td  align="left" valign="top"><?php echo stripslashes($users->email);?></td>
          </tr>
          <tr> 
            <td align="right" valign="top" class="tbllogin">Can Download Files</td>
             <td align="center" valign="top" class="tbllogin">:</td>
            <td  align="left" valign="top"><?php echo stripslashes($users->department_id);?></td>
          </tr>
    ...
    <td align="center">
		<table width="100%" align="center" cellpadding="5" cellspacing="2">
          ...
          <tr> 
            ...
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="text" name="name" id="name" class="validate[required] inplogin" value="<? echo stripslashes($users->name);?>"> 
            </td>
          </tr>
		   <tr> 
            <td align="right" valign="top" class="tbllogin"><font color="#FF0000">*</font>Password</td>
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="text" name="password" id="password" class="validate[required] inplogin" value="<? echo stripslashes($users->password);?>">&nbsp;&nbsp;<input type="button" name="generate_pass" id="generate_pass" value="Generate Password" onclick="generate_password();" /> 
            </td>
          </tr>
		  <tr> 
            <td align="right" valign="top" class="tbllogin">Can Upload Files?</td>
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="radio"  name="can_upload" id="upload_files_yes" value="Y" <?php if(($users->can_upload)=="Y") {?> checked="checked"<?php } ?> />&nbsp;Yes &nbsp;&nbsp; <input type="radio" name="can_upload" id="upload_files_no" value="N" <?php if(($users->can_upload)=="N") {?> checked="checked"<?php } ?> />&nbsp;No
            </td>
          </tr>
		  ...
		  <tr> 
            <td align="right" valign="top" class="tbllogin">Can Download Files?</td>
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="radio" name="can_download" id="download_files_yes" value="Y" <?php if(($users->can_download)=="Y") {?> checked="checked"<?php } ?> />&nbsp;Yes &nbsp;&nbsp; <input type="radio" name="can_download" id="download_files_no" value="N" <?php if(($users->can_download)=="N") {?> checked="checked"<?php } ?> />&nbsp;No
            </td>
          </tr>
          ...
          <tr> 
            <td class="tbllogin" align="right" valign="top">Is Active</td>
            <td align="center" valign="top" class="tbllogin">:</td>
            <td valign="top"> <select name="is_active" class="inplogin">
                <option value="Y" <? echo $users->is_active=='Y'?'selected':'';?>>Yes</option>
                <option value="N" <? echo $users->is_active=='N'?'selected':'';?>>No</option>
              </select> </td>
          </tr>
          <tr> 
            <td height="32" >&nbsp;</td>
            <td >&nbsp;</td>
            <td> <input name="submit" type="submit" class="button" value="<? echo $user_id >0 ?'Update':'Add'?>"> 
              &nbsp; <input name="button" type="button" class="button" onClick="javascript:window.location='<?=$_SERVER['PHP_SELF']?>';"  value="Cancel"> 
            </td>
          </tr>
        </table>
	</td>
