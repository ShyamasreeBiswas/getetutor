...
{	
	...
	if($id>0) 
	{
		if($departments->save($id)) 
		{
			$GLOBALS['admin_msg'] = "Department updated successfully";
			disphtml("main();");
		} else {
			$GLOBALS['admin_msg'] = $departments->admin_msg;
		  	disphtml("saveData(".$id.");");
		}
	} 
	else 
	{
		if($departments->save($id="NULL")) 
		{
...
{
	$departments->deleteData($id);
	$GLOBALS['admin_msg'] = "Department deleted successfully";
	disphtml("main();");
} 
else 
{
...
function main() 
{
	...
	if($orderType && $fieldName) {
		...
		$member_sql = " SELECT 	* 
						FROM 	".$departments->table_name."  ".$orderBy."  
						LIMIT 	".$GLOBALS['start'].",".$GLOBALS['show'];
						
						//echo $member_sql; die;
						
		$row=$departments->search(" SELECT COUNT(*) FROM ".$departments->table_name."  ");
		$count=$row[0][0];
	
	$result=$departments->search($member_sql);
?>
...
<table width="98%" align="center" border="0" cellpadding="5" cellspacing="2"  class="border">
  <tr class="TDHEAD"> 
    <td colspan="9">Department Management</td>
  </tr>
  <tr class="text_normal" bgcolor="#E7E7F7"> 
    <td width="10%" align="center" ><div align="center"><strong>SL</strong></div></td>
    <td width="22%" ><strong>Department Id</strong></td>
	<td width="30%" ><strong>Department Code</strong></td>
  ...
  <?php
	...
	$cnt=$GLOBALS[start]+1;
	while($result[$i]!=NULL) {
		$departments_arr = $departments->getDepartmentName($result[$i]['code']);
	?>
  <tr onMouseOver="this.bgColor='<?php echo SCROLL_COLOR;?>'" onMouseOut="this.bgColor=''"> 
    ...
    <td valign="top" align="left"><?php echo $result[$i]['code'];?> </td>
    ...
    <td align="center" valign="top"><a href="javascript:viewData( <?php echo $result[$i]['id'];?>);" title="View Department Details"><img src="images/preview_icon.gif" border="0"></a></td>
    <td align="center" valign="top"><a href="javascript:editData( <?php echo $result[$i]['id'];?>);" title="Edit Department Details"><img src="images/edit_icon.gif" border="0"></a></td>
    <td align="center" valign="top"><a href="javascript:deleteData( <?php echo $result[$i]['id'];?>);" title="Delete Department Details"><img name="xx" src="images/delete_icon.gif" border="0"></a></td>
  </tr>
  <?php 
	$i++;
	}
		...
		<table width="100%" align="center" cellpadding="5" cellspacing="2">
          <tr class="TDHEAD"> 
            <td colspan="3" style="padding-left:10px;" class="text_main_header"> 
             View Department's Information</td>
          </tr>
          <tr> 
            <td width="26%" align="right" valign="top" class="tbllogin">Department Code</td>
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td align="left" valign="top"><?php echo  stripslashes($departments->code); ?>
            </td>
          </tr>
          <tr> 
          <td align="right" valign="top" class="tbllogin">Department Name </td>
          <td align="center" valign="top" class="tbllogin">:</td>
          <td  align="left" valign="top"><?php echo stripslashes($departments->name);?></td>
          </tr>
		  ...
		  <tr> 
            ...
            <td align="center" valign="top" class="tbllogin">:</td>
            <td valign="top">
                <?php echo $departments->status=='N' ? 'In Active' : 'Active';?>
            </td>
          </tr>
          <tr> 
            <td height="32" >&nbsp;</td>
...
<form name="frmDepartment" id="frmDepartment" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data"   >
  ...
  <tr>
    <td align="center">
		<table width="100%" align="center" cellpadding="5" cellspacing="2">
          <tr class="TDHEAD"> 
            <td colspan="3" style="padding-left:10px;" class="text_main_header"> 
              <?php echo ucwords($_POST['mode']);?> Department Information</td>
          </tr>
          <tr>
          ...
          <tr> 
            <td align="right" valign="top" class="tbllogin"><font color="#FF0000">*</font>Department Code</td>
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="text" name="code" id="code" class="validate[required] inplogin" value="<?php echo stripslashes($departments->code);?>"></td>
          </tr>
		   
          <tr> 
            <td class="tbllogin" align="right" valign="top"><font color="#FF0000">*</font>Department Name</td>
            <td align="center" valign="top" class="tbllogin">:</td>
            <td valign="top"><input type="text" name="name" id="name" class="validate[required] inplogin" value="<?php echo stripslashes($departments->name);?>"></td>
          </tr>
          <tr> 
            <td height="32" >&nbsp;</td>
            <td >&nbsp;</td>
