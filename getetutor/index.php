...
function show_dep_course(val)
{
	if(val == 'T')
	{
		$("#select_department_tr").show();
		$("#select_course_tr").show();
	}
	if(val == 'S')
	{
		$("#select_department_tr").hide();
		$("#select_course_tr").hide();
	}
}
</script>
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    {
    document.getElementById("pwdText").innerHTML=xmlhttp.responseText;
    }
  }
...
<table width="100%" align="center" border="0" cellpadding="5" cellspacing="2"  class="border">
	...
	<table width="25%" cellpadding="5" cellspacing="0" border="0" align="left" class="border">
		...
		<tr>
			<td>Login</td>
			<td>:</td>
			<td><input name="username" id="username" type="text" value="" maxlength="15" class="inplogin" /></td>
		</tr>
		<tr>
			<td>Password</td>
			<td>:</td>
		...
		<tr>
			<td colspan="2">&nbsp;</td>
			<td><input type="submit" name="Login" value=" Login " class="inplogin">
             <br /> 
            ...
            <div id="inline" style="width:350px;height:150px;overflow:auto;">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0" style="border:1px solid #999;">
                    ...
                    <tr>
                        <td style="background:#F0F0F0;" align="center" id="pwdText">
  ...
  <?php } $_SESSION['msg1']=''; ?>
   ...
   <table width="834">
		<tr>
			<td height="150">
<form name="frmUser" id="frmUser" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" >
    ...
    <td align="center">
		<table width="100%" align="center" cellpadding="5" cellspacing="2">
          ...
          <tr> 
            ...
            <td width="3%" align="center" valign="top" class="tbllogin">:</td>
            <td width="71%" align="left" valign="top"><input type="text" name="username" id="username" class="validate[required, custom[onlyLetterNumber]] inplogin" value=""> &nbsp;&nbsp;<div id="username_msg" align="left"></div>
            </td>
          </tr>
          ...
          <tr> 
            ...
            <td valign="top"> 
            	<input type="radio" name="type" value="T" onclick="show_dep_course(this.value)" />Tutor
                <input type="radio" name="type" value="S"  checked="checked" onclick="show_dep_course(this.value)" />Student
            </td>
          </tr>
         
          <tr id="select_department_tr" style="display:none;"> 
		...
		?>
		  ...
		  <tr id="select_course_tr" style="display:none;"> 
    ...
    <table width="834">
		<tr>
			<td height="150" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            	<font color="#0000FF" size="4px;">Welcome To GetETutor!!</font><br /><br />                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <font color="#FF00FF" size="2px;">Yet Not Register ??</font>
                <a href="index.php?page=register" style="font-size:14px; color:#0000FF;">Register</a>
            </td>
          </tr>
     </table>
    <?php }?>
