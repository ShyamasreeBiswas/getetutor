...
$link = mysql_connect("localhost","getetutor","z5tTb%&1qBdv");

mysql_select_db("getetutor",$link) or die(mysql_error());
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
	...
	<tr>
		...
		<td width="55%"><textarea name="t1" rows="7" cols="70"><?php stripslashes($_POST[t1])?></textarea></td>
                	...
                	<td align="center">
						...
						<select name="table_name" onChange="show_table();">
                            ...
                            ?>
                            	...
                            	<option value="<?php echo $rec_show_all[0]?>" <?php echo ($rec_show_all[0] == $_POST['table_name'])?'SELECTED':'';?>><?php echo $rec_show_all[0]?></option><?
	...
	<tr>
        ...
        <td align="left" height="50"><input type="submit" value="Submit" name="Submit"></td>
